...
//note, to modify unit to be a DCC turnout, disconnect LED, use RB0 as data in.
//the led could be muxed onto RA4.  led could act as a pullup, button would pull RA4 down.


volatile union {
uint8_t		port;
struct {
	unsigned	RB0	:1;   //pin [6] IR LED, also INT pin
...
#define LED    			sPORTB.RB0  //IR LED
#define	indicator		sPORTB.RB7  //user indicator
...
/*
routes are;
[1] solenoid1normal, solenoid2 normal  is siding 1
[2] solenoid1thrown, solendoid2 thrown  is siding 2
[3] solendoi1thrown, solendoid2 normal  is siding 3
